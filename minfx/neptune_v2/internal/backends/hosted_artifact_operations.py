...
def _compute_artifact_size(artifact_file_list: list[ArtifactFileData]) -> int | None:
    artifact_size = 0
...
def _extract_file_list(path: list[str], entries: list[tuple[str, str | None]]) -> list[ArtifactFileData]:
