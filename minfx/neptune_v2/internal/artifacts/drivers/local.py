...
class LocalArtifactDriver(ArtifactDriver):
    ...
    @classmethod
    def _serialize_metadata(cls, metadata: dict[str, typing.Any]) -> dict[str, str]:
        return {
    ...
    @classmethod
    def _deserialize_metadata(cls, metadata: dict[str, str]) -> dict[str, typing.Any]:
        return {
            "file_path": metadata["file_path"],
    ...
    def get_tracked_files(cls, path: str, destination: str | None = None) -> list[ArtifactFileData]:
        ...
        stored_files: list[ArtifactFileData] = []
