...
from minfx.neptune_v2.internal.artifacts.local_file_hash_storage import LocalFileHashStorage
from minfx.neptune_v2.internal.artifacts.types import (
    ArtifactFileData,
    ArtifactMetadataSerializer,
)
from minfx.neptune_v2.internal.artifacts.utils import sha1
...
class FileHasher:
    ...
    @classmethod
    def _number_to_bytes(cls, int_value: int, bytes_cnt: Any) -> bytes:
